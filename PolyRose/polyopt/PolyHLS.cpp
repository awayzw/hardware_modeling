			   ...
			   PolyRoseOptions& polyoptions)
{
  ...
  //weiwei
  SgGlobal* global_scop = SageInterface::getGlobalScope(scopRoot);
  SgVariableDeclaration* global_energy =
    SageBuilder::buildVariableDeclaration("energy", SageBuilder::buildDoubleType(), SageBuilder::buildAssignInitializer(SageBuilder::buildDoubleVal(0)), isSgScopeStatement(scopRoot));
  global_scop->prepend_declaration(global_energy);
