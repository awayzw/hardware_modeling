...
public:
	SC_FunctionModule(SgFunctionDeclaration* func, SgScopeStatement* scope, int depth, bool isroot);
	//SC_FunctionModule(SgFunctionDeclaration* func, SgScopeStatement* scope, SgScopeStatement* rootscope, int depth, bool isroot);
	void process(std::vector<string> globalUnrollFactor, bool no_pretile);
	void addToFile();
